...
export function parseAuditCheckDetails(
...
/** Severity is informational -- tells the user *how bad* an issue is, not whether it passed/failed. */
...
/** Severity badges use outline variant to stay visually subdued. */
export function variantSeverity(): BadgeVariant {
	return "outline";
}
